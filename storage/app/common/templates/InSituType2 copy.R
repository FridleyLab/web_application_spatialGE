...
i = names(stclust_stlist@tr_counts)[1]
merged_cts = stclust_stlist@tr_counts[[i]]
...
if(length(stclust_stlist@tr_counts) > 1){
  for(i in names(stclust_stlist@tr_counts)[-1]){
    df_tmp = stclust_stlist@tr_counts[[i]]
