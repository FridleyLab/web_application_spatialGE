...
#write.table(rbind(master_ann_orig[-c(mod_annots), ], master_ann), 'stdiff_annotation_variables_clusters.csv', quote=F, row.names=F, col.names=F, sep=',')
