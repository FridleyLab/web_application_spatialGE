                                            ...
                                            <div v-for="(sample, index) in samples" class="tab-pane fade min-vh-50 mt-3 ms-4" :class="index === 0 ? 'show active' : ''" :id="sample.name + 'STdeconvolve2'" role="tabpanel" :aria-labelledby="sample.name + 'STdeconvolve2-tab'">
                                                ...
                                                <ul class="nav nav-tabs" :id="'stdec2_plots_tab_' + sample.name" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link active" :id="'stdec2_scatterpie_tab_' + sample.name" data-bs-toggle="tab" :data-bs-target="'#stdec2_scatterpie_' + sample.name" type="button" role="tab" :aria-controls="'stdec2_scatterpie_' + sample.name" aria-selected="true">Scatterpie</button>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" :id="'stdec2_topics_tab_' + sample.name" data-bs-toggle="tab" :data-bs-target="'#stdec2_topics_' + sample.name" type="button" role="tab" :aria-controls="'stdec2_topics_' + sample.name" aria-selected="true">Topic annotations</button>
                                                    </li>
                                                </ul>
                                                            ...
                                                            <div class="mt-6 d-flex flex-column justify-content-start">
                                                                ...
                                                                <div v-if="'current_annotation' in topic">
                                                                    ...
                                                                    <div v-if="topicNamesChanged" class="p-3 text-center mt-4">
                                                                        <div class="text-warning">Once you finish editing topic annotations, please click the following button</div>
