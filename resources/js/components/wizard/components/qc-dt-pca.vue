    ...
    <form>
        ...
        <div :class="generating_plots || generating_pca ? 'disabled-clicks' : ''">
            ...
            <div class="my-3 text-bold">
                Dimensionality reduction of pseudo-bulk counts (PCA and UMAP)
            </div>
            <div>
                The PCA and UMAP plots generated by this module result from calculating the average expression of genes across spots within each sample. This pseudo-bulk analysis does not incorporate any spatial component of the data.
                The PCA/UMAP is calculated with a number of user-selected most variable genes based on standard deviation.<span class="text-bold">Note:</span> Pseudo-bulk analysis can only be performed on projects with four samples or more.
            </div>


            <div class="row justify-content-center text-center m-4">
                <div class="w-100 w-md-80 w-lg-70 w-xxl-55">
                    <div class="me-3 mb-3">Number of most variable genes to perform dimensionality reduction (PCA/UMAP): <input type="number" class="text-end text-sm border border-1 rounded w-25 w-md-35 w-xxl-15" v-model="params.n_genes"><show-modal tag="qcpca_number_variable_genes"></show-modal></div>
