...
<div class="m-4">
    <form>
        ...
        <div class="row mt-3">
            <div class="float-end">
                <input type="button" class="btn btn-outline-info float-end" :class="generating_quilt || !params.color_pal.length || !params.plot_meta.length || !params.sample1.length || !params.sample2.length || (params.sample1===params.sample2) ? 'disabled' : ''" :value="generating_quilt ? 'Please wait...' : 'Generate plot'" @click="quiltPlot">
            </div>
        </div>
