        ...
        <div v-if="!processing && ('stdiff_s' in project.project_parameters)">
            <div>
                ...
                <div class="tab-content" id="myTabContent">
                    <div v-for="(sample, index) in stdiff_s.samples" class="tab-pane fade min-vh-50" :class="index === 0 ? 'show active' : ''" :id="sample" role="tabpanel" :aria-labelledby="sample + '-tab'">

<!--                        <a :href="stdiff_s.base_url + 'stdiff_s_' + sample + '.csv'" class="btn btn-sm btn-outline-info m-6" download>CSV results</a>-->

                        <div class="m-4" v-if="(sample in results) && results[sample].loaded">
<!--                            <a :href="stdiff_s.base_url + 'stdiff_s_' + sample + '.csv'" class="btn btn-sm btn-outline-info my-3" download>CSV results</a>-->
