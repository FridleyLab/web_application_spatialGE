...
<div class="m-4">
    <form>
        ...
        <div>
            Remove genes by token <input type="text" placeholder="^MT-">
        </div>
        ...
        <div class="mt-4 border border-1 rounded p-2 gap-1">
            <div class="row row-cols-2">
                <div class="col border border-2 border-start-0 border-top-0 border-bottom-0">
                    <numeric-range title="Spot/cell counts" :start-min="0" :start-max="10000" :start-step="500" :start-default="params.spot_minreads" start-label="min" :end-min="0" :end-max="10000" :end-step="500" :end-default="params.spot_maxreads" end-label="max" @updated="(min,max) => {params.spot_minreads = min; params.spot_maxreads = max}"></numeric-range>
                </div>
                <div class="col">
        ...
        <div class="mt-4 p-2 border border-1 rounded">
            <div class="row row-cols-2">
                ...
                <div class="col">
                    <numeric-range title="Gene spots" :start-min="0" :start-max="6000" :start-step="500" :start-default="params.gene_minspots" start-label="min" :end-min="0" :end-max="6000" :end-step="500" :end-default="params.gene_maxspots" end-label="max" @updated="(min,max) => {params.gene_minspots = min; params.gene_maxspots = max}"></numeric-range>
                </div>
            </div>
        </div>
